            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:space-x-6">
                        <Link to="/admin" className="text-blue-100 hover:text-white font-medium transition-colors">
                            Admin
                        </Link>

                        <Link to="/login" className="text-blue-100 hover:text-white font-medium transition-colors">
                            Login
                        </Link>

                        <Link to="/cart" className="relative p-2 text-blue-100 hover:text-white transition-colors">
            ...
            <div className="hidden sm:block border-t border-gray-100 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex space-x-8 h-12 items-center text-sm font-medium">
                        ...
                        <Link to="/products?offers=true" className="text-red-500 hover:text-red-700 font-semibold">
                            Ofertas
                        </Link>
                ...
                <div className="sm:hidden border-t border-gray-200">
                    <div className="pt-4 pb-4 px-4">
                        <div className="relative w-full mb-4">
                            ...
                            <input
                                type="text"
                                className="block w-full pl-10 pr-3 py-2 border border-blue-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm text-gray-900"
                                placeholder="Buscar..."
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                            />
                    ...
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <Link to="/products?offers=true" className="border-l-4 border-transparent text-red-600 hover:bg-red-50 hover:text-red-700 block pl-3 pr-4 py-2 text-base font-medium">
                            Ofertas
                        </Link>
                        <Link to="/blog" className="border-l-4 border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 text-base font-medium">
                            Blog
                        </Link>
